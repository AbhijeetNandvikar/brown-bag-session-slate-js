...
const App = () => {
  ...
  return (
    <div>
      <Slate editor={editor} value={initialValue}>
        <Editable onKeyDown={onKeyDownHandler}/>
        {showCommandMenu && (
          <Portal>
            <div ref={ref}>
              {commandList.map((command, i) => {
...
```js 51:62 showNumbers title="6. Add editor change handler"
import React, { useEffect, useRef, useState } from "react";
import { Slate, Editable, withReact, ReactEditor} from "slate-react";
...
```js 52:77 showNumbers title="7. Add execute command function"
import React, { useEffect, useRef, useState } from "react";
import { Slate, Editable, withReact, ReactEditor} from "slate-react";
...
```js 52:68 showNumbers title="8. Add useEffect for portal position and command search"
import React, { useEffect, useRef, useState } from "react";
import { Slate, Editable, withReact, ReactEditor} from "slate-react";
